 ...
 * `list-guestbook-records.ts`, this script's request will be authenticated with
 * the PDS of the requesting user.
 *
 ...
 * appview server and gets an augmented version of the guestbookss, which
 * includes metadata like the number of submissions.
 *
 */
